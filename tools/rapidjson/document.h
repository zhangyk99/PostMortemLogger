...
struct GenericStringRef {
    ...
    //! Explicitly createChannel string reference from \c const character pointer
#ifndef __clang__ // -Wdocumentation
    /*!
        This constructor can be used to \b explicitly  createChannel a reference to
...
public:
    ...
    /*! Creates an empty document of specified type.
        \param type             Mandatory type of object to createChannel.
